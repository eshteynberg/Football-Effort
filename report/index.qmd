...
tracking_bc |> 
  ...
  cols_label(gameId = "Game", playId = "Play", bc_id = "Ball Carrier", displayName = "Name",
             frameId = "Frame", event = "Event", x = "X Coordinate", y = "Y Coordinate", s_mph = "Speed (mph)", 
...
### Chase Edmonds
```{r}
#| label: Edmonds nlrq 2
#| message: false
#| warning: false
#| cache: true
eff_function_nlrq("Chase Edmonds", graph = TRUE)
```
...
#| warning: false
#| cache: true
eff_function_nlrq("D'Andre Swift", graph = TRUE)
```
:::
...
# rb_menu <- c("Christian McCaffrey", "Khalil Herbert", "Saquon Barkley", 
#                 "Chase Edmonds", "D'Andre Swift")
# 
# # Initialize plot
# fig1 <- plot_ly()
# all_traces <- list()
...
#| message: false
#| warning: false
eff_function_qgam("Chase Edmonds", graph = TRUE)
```
...
#| message: false
#| warning: false
eff_function_qgam("D'Andre Swift", graph = TRUE)
```
:::
...
# 
# # Player list
# rb_dd_menu <- c("Christian McCaffrey", "Khalil Herbert", "Saquon Barkley", 
#                 "Chase Edmonds", "D'Andre Swift")
# 
# # Initialize plot
# fig5 <- plot_ly()
...
## References
<div style="text-indent: -2.5em; padding-left: 2.5em; margin-bottom: 1em;">
...
## Contact Information
* **Emily Shteynberg**: emilyshteynberg@gmail.com
* **Luke Snavely**: lsnavely28@gmail.com
* **Sheryl Solorzano**: sherylslz46@gmail.com
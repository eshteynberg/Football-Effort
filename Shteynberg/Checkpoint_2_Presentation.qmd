...
* Effort v1 = $\left(n_{\text{above}}+\sum\limits_{i=1}^{n_{\text{below}}} {\frac{1}{1+d_i}}\right)\bigg/n_{\text{total}}$

* Effort v2 = percentage of total points that lie in between the percentile $P_{99}$ and $P_{99}-3$
...
* Potential fix: Effort v3 = $\left(\sum\limits_{i=1}^{n_{\text{below}}} {\frac{1}{1+d_i}} + \frac{.01}{\text{% of points above } P_{99}}\right)\bigg/n_{\text{total}}$

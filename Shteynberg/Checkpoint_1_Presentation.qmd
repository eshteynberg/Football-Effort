...
<div style="display: flex; justify-content: center; margin-top: -7vh;">
  <img src="ComboAnimation.gif" style="max-height: 96vh; width: auto;" />
</div>
...
![](effort_vs_epa_plot.png){fig-align="center" width=90%}
...
![](effort_vs_yards_plot.png){fig-align="center" width=90%}

## Avg KE and Avg EPA segment RBs into 4 quadrants

![](quadrant_archetype_plot.png){fig-align="center" width=90%}

## Avg EPA for the 5 players with the highest KE and the 5 players with the lowest KE

![](KE_high_low_plot.png){fig-align="center" width=90%}

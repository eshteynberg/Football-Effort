...
fig1 <- eff_function_rqss("Saquon Barkley", graph = TRUE)
fig2 <- eff_function_rqss("Rex Burkhead", graph = TRUE)
...
# Show only the first trace by default
fig$x$data[[2]]$visible <- FALSE

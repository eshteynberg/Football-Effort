  ...
  if (graph == TRUE) {
    ...
    p <- plot_ly() |>
      ...
      layout(
        ...
        title = list(
          text = "We consider points close to and above a player's<br><i>maximum acceleration frontier</i> effortful",
          font = list(size = 18)
        ),
        xaxis = list(title = "Speed (mph)", titlefont = list(size = 14)),
        yaxis = list(title = "Magnitude of acceleration (m/s²)", titlefont = list(size = 14)),
        legend = list(
          x = 1.05,
          y = 0.5,
          xanchor = "left",
...
![](photos/MaxAccel.png){width=80%}

### Effort vs. Max Speed
![](photos/MaxSpeed.png){width=80%}

### Effort vs. Number of Rushes
![](photos/NumRushes.png){width=80%}
:::

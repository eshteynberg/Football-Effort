...
### Top and bottom players for proportion score:

```{r}
#| label: intercative-quant-regression
#| fig-cap: "Percentage of total points that lie in between the percentile $P_{99}$ and $P_{99}-3$ for top and bottom running backs"
#| message: false
#| warning: false
...
rb_dd_list <- c("Chase Edmonds", "Rachaad White", "D'Andre Swift", 
                ...
                "Josh Jacobs", "James Cook", "Melvin Gordon", "Brian Robinson",

...
The data were obtained from the NFL Big Data Bowl 2025, an annual league-sponsored analytics competition that provides game, play, player, and tracking data recorded at 10 frames per second [@]. The dataset covers weeks 1-9 of the 2022 NFL season, comprising 136 games. 
...
Our initial approach was adapted from prior research building individual acceleration-speed (A-S) profiles of soccer players [@] For each RB, we plot the frame-level A-S profile based on the maximal acceleration they could generate for every possible running speed as follows:

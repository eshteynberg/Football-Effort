...
p1 <- eff_function_nlrq_plotly("Saquon Barkley", graph = TRUE)
p2 <- eff_function_nlrq_plotly("James Cook", graph = TRUE)

# Then assign subplot titles explicitly:
subplot(p1, p2, nrows = 1, margin = 0.05, shareX = FALSE, shareY = FALSE, titleX = TRUE, titleY = TRUE) |>
  layout(annotations = list(
    list(
      text = "Saquon Barkley",
      x = 0.225, y = 1.05, xref = "paper", yref = "paper",
      showarrow = FALSE, font = list(size = 16, color = "black", family = "Arial Bold")
    ),
    list(
      text = "James Cook",
